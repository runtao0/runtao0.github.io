...
/***/ function(module, exports, __webpack_require__) {
	...
	function removeButtons() {
	  ...
	  var benchButton = document.getElementById("benchmark");
	  var growthGunButton = document.getElementById("growthgun");
	  ...
	  benchButton.removeEventListener('click', createBenchmark);
	  growthGunButton.removeEventListener('click', createGrowthGun);
	...
	function addBenchmarkButton() {
	  var benchButton = document.getElementById("benchmark");
	  benchButton.addEventListener('click', createBenchmark);
	}
	
	function createBenchmark() {
	  makeGrid(function (x, y, coord) {
	    initPattern(x, y, coord, Patterns.createBenchmark(50, 100));
	  });
	  addBlocks();
	}
	...
	function addGrowthGunButton() {
	  var growthGunButton = document.getElementById("growthgun");
	  growthGunButton.addEventListener('click', createGrowthGun);
	}
	
	function createGrowthGun() {
	  makeGrid(function (x, y, coord) {
	    initPattern(x, y, coord, Patterns.shiftPattern(Patterns.GROWTH_GUN, 50, 30));
	  });
	  addBlocks();
	}
