...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  ...
	  $buttons.on("click", "button", function (event) {
	    ...
	    switch (event.target.id) {
	      ...
	      case 'cross':
	        ...
	        break;
	      case 'benchmark':
	        createPattern(Patterns.createBenchmark(50, 99));
	        break;
	      case 'garden':
	  ...
	  function onDocumentMouseMove(event) {
	    event.preventDefault();
	    scene.setMouse(event.clientX / window.innerWidth * 2 - 1, -(event.clientY / window.innerHeight) * 2 + 1);
	    scene.setRayfromCamera();
	    var intersects = scene.getIntersectObjects(objects);
	  ...
	  function onDocumentMouseDown(event) {
	    ...
	    scene.setMouse(event.clientX / window.innerWidth * 2 - 1, -(event.clientY / window.innerHeight) * 2 + 1);
	    scene.setRayfromCamera();
	    var blockIntersects = scene.getIntersectObjects(scene.grid.cells);
	    var planeIntersects = scene.getIntersectObjects(objects);
	    var intersects = blockIntersects.concat(planeIntersects);
	    ;
	    if (intersects.length > 0) {
	      var intersect = intersects[0];
	      // delete cube
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Scene = function () {
	  ...
	  _createClass(Scene, [{
	    key: '_addGeneration',
	    value: function _addGeneration() {
	      this.scene.add(this.grid.cells);
	    }
	  }, {
	    key: '_cameraFollowGrowth',
	    value: function _cameraFollowGrowth() {
	    ...
	    key: '_addPlane',
	    value: function _addPlane(objects) {
	    ...
	    key: '_createRollOver',
	    value: function _createRollOver() {
	      this.scene.add(this.rollOverMesh);
	    }
	  }, {
	    key: '_setPositions',
	    value: function _setPositions() {
	      this.camera.position.set(0, -1000, 700);
	      this.camera.lookAt(new THREE.Vector3(0, 0, 0));
	    }
	  }, {
	    key: '_addLightToScene',
	    value: function _addLightToScene() {
	    ...
	    key: 'setUpSceneAll',
	    value: function setUpSceneAll(objects) {
	    ...
	    key: 'getIntersectObjects',
	    value: function getIntersectObjects(objectArray) {
	    ...
	    key: 'setRollOverMesh',
	    value: function setRollOverMesh(intersectPoint) {
	    ...
	    key: 'setRayfromCamera',
	    value: function setRayfromCamera() {
